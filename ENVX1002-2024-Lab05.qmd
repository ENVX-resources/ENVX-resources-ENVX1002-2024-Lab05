...
- [ENVX1002_Data5.xlsx](data\ENVX1002_Data5.xlsx) if you are viewing the html file from Github <https://Github.com/envx-resources>
...
# write your R code here
hist(sting$Stinging)
boxplot(sting$Stinging)


qqnorm(sting$Stinging)
qqline(sting$Stinging)
```
